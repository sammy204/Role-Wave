-- Let a candidate delete a resolved offer from their workspace. The
-- security-definer function keeps this operation narrow and never permits
-- deletion while an offer is awaiting a response.
...
begin
  ...
  if not found then
    raise exception 'Offer cannot be removed.' using errcode = '42501';
  end if;
end;
$function$;
